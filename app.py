...
model = load_model("/content/drive/MyDrive/MAKAUT/tf_2/keras_model.h5", compile=False)  #
class_names = open("/content/drive/MyDrive/MAKAUT/tf_2/labels.txt", "r").readlines()
